...
DEFAULT_PARAMS.set("light_color", [0.35, 0.35, 0.35], [0.35, 0.35, 0.35], [0.5, 0.5, 0.5])
# DEFAULT_PARAMS.set(
#     "light_ambient", [0.45, 0.45, 0.45], [0.35, 0.35, 0.35], [0.55, 0.55, 0.55]
# )
DEFAULT_PARAMS.set(
    "light_ambient", [0.35, 0.35, 0.35], [0.25, 0.25, 0.25], [0.45, 0.45, 0.45]
)
...
DEFAULT_PARAMS.set("turn_step", 15, 15, 15)
DEFAULT_PARAMS.set("bot_radius", 0.4, 0.38, 0.42)
# TODO : Should these camera properties be randomized?
DEFAULT_PARAMS.set("cam_pitch", -5, -5, -5)
DEFAULT_PARAMS.set("cam_fov_y", 60, 60, 60)
DEFAULT_PARAMS.set("cam_height", 1.5, 1.5, 1.5)
DEFAULT_PARAMS.set("cam_fwd_disp", 0, 0, 0)